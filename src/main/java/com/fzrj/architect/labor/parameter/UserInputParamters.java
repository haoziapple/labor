...
/**
 * @className:com.fzrj.architect.labor.parameter.UserInputParamters
 * @description:用户输入参数
 * @version:v1.0.0
 * @date:2017年6月22日 下午1:34:22
 * @author:WangHao
 */
public abstract class UserInputParamters
{
	...
	public static String[] genInputArgs(String path, String projectname, String dbHost, String dbPort, String dbUser,
			String dbPassword, String dbName, String strategy, String packageName)
	{
